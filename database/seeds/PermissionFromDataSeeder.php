...
class PermissionFromDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            //Wallet List
            ['group' => 'personal','action' => 'View','for' => 'View Users Wallets','route' => $this->filtertext('adminWalletList')],
            ...
            ['group' => 'transaction_withdrawal','action' => 'Accept','for' => 'Withdrawal Transaction Accept','route' => $this->filtertext('adminPendingDepositAcceptProcess')],
            ...
            ['group' => 'transaction_deposit','action' => 'View','for' => 'Accept Pending Deposit','route' => $this->filtertext('adminAcceptPendingWithdrawal')],
            ...
            //Pending token
            ['group' => 'pending','action' => 'View','for' => 'View Pending Token History','route' => $this->filtertext('adminPendingDepositHistory')],
            ['group' => 'pending','action' => 'Accept','for' => 'Accept Pending Token','route' => $this->filtertext('adminPendingDepositAccept')],
            ['group' => 'pending','action' => 'Reject','for' => 'Reject Pending Token','route' => $this->filtertext('adminPendingDepositReject')],

            //Token Gas History
            ['group' => 'gas','action' => 'View','for' => 'View Token Gas Send History','route' => $this->filtertext('adminGasSendHistory')],

            //Token Gas History
            ['group' => 'token','action' => 'View','for' => 'View Token Receive History','route' => $this->filtertext('adminTokenReceiveHistory')],
