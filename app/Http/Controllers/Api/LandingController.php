...
class LandingController extends Controller
{
    ...
    public function commonSettings()
    {
        ...
        $data['public_chanel_name'] = env("PUSHER_PUBLIC_CHANEL_NAME") ?? 'edx_public_chanel';
        $data['private_chanel_name'] = env("PUSHER_PRIVATE_CHANEL_NAME") ?? 'edx_private_chanel';
    ...
    public function index()
    {
        ...
        $data['landing_description'] = $settings['landing_description'] ?? __('EDX exchange is such a marketplace where people can trade directly with each other.');
