...
{{--                <div class="logo">--}}
{{--                    <a href="{{route('adminDashboard')}}"><img src="{{ image("logo.jpeg") }}" class="img-fluid logo-large" alt=""></a>--}}
{{--                    <a href="{{route('adminDashboard')}}"><img src="{{ image("logo.jpeg")  }}" class="img-fluid logo-small" alt=""></a>--}}
{{--                </div>--}}
{{--            </div>--}}
